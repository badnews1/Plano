 ...
 * 
 * Минималистичный дизайн с формой входа.
...
export const LoginPage: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t('auth.login.errorGoogle'));
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              disabled={isLoading}
              aria-label={t('auth.login.emailAria')}
            />
          </div>
        ...
        <div className="flex items-center gap-4 my-6">
          ...
          <span className="text-sm text-text-tertiary">{t('auth.login.divider')}</span>
          <div className="flex-1 h-px bg-border-secondary" />
        </div>
